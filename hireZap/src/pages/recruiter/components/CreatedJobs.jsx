            ...
            {!hasJobs ? (
                ...
                <>
                  ...
                  <div className="space-y-4">
                    {currentJobs.map((job) => {
                      // Use company from Redux state instead of job.company
                              ...
                              <div className="flex items-start space-x-4 flex-1 min-w-0">
                                  ...
                                  {jobCompany.logo_url ? (
                                    <img
                                      ...
                                      onError={(e) => {
                                        ...
                                        e.target.parentElement.innerHTML = `<div class="w-full h-full bg-gradient-to-br from-teal-500 to-teal-600 flex items-center justify-center text-white font-bold text-xl">${jobCompany.company_name?.charAt(0) || 'C'}</div>`;
                                      }}
                                    />
                                  ) : (
                                    <div className="w-full h-full bg-gradient-to-br from-teal-500 to-teal-600 flex items-center justify-center text-white font-bold text-xl">
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-start justify-between gap-2 mb-2">
                                    ...
                                    >
                                      {job.status === 'active' || job.job_status === 'active' ? 'Active' : 'Paused'}
                                    </span>
                                  </div>
                  ...
                  {totalPages > 1 && (
                    <Pagination
                      ...
                      totalItems={recruiterJobs.length}
