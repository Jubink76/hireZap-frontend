              ...
              <div className="p-6">
                <div className="flex items-center justify-between">
                  <div className="flex-1 min-w-0"> {/* Added min-w-0 to prevent overflow */}
                    <p className="text-sm font-medium text-slate-600 mb-1 truncate">{stat.label}</p> {/* Added truncate */}
                    ...
                    <div className="flex items-center mt-2">
                      ...
                      <span className="text-sm text-slate-500 ml-1 hidden sm:inline">from last month</span> {/* Hide on small screens */}
                    </div>
                  </div>
