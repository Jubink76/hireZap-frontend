...
import profifleAvatar from '../../../assets/profile_avatar.jpg'
const AdminProfileCard = ({ admin, onClick }) => (
  <button 
  ...
  >
    <div className="flex items-center space-x-3">
      ...
      <div className="min-w-0 flex-1">
        <h3 className="font-medium text-slate-900 truncate text-sm">{admin.name}</h3>
        <p className="text-xs text-slate-600 truncate">{admin.role}</p>
      </div>
    </div>
  </button>
);
